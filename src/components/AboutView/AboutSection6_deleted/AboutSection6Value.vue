<template>
  <div class="c-what-we-do__product" @mouseover="getValueIndex" @mouseleave="removeValueIndex" @focusin="handleFocusIn" @focusout="handleFocusIn">
    <transition
          name="body_fade"
          mode="out-in"
        >
