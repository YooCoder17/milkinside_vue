<!-- eslint-disable -->
<template>
  <div class="c-what-we-do__product" style="min-width: 320px; margin-top:0" @mouseover="getValueIndex" @mouseleave="removeValueIndex" @focusin="handleFocusIn" @focusout="handleFocusIn">
    <transition
          name="body_fade"
          mode="out-in"
        >
      <div
        ...
        style="margin-top:auto; margin-bottom:auto;height: 26vh; margin-left:1.2vw" 
      >
