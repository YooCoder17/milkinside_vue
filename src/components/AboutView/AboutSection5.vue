    ...
    <div class="c-services__sections">
      ...
      >
          ...
          <transition
            ...
            mode="out-in"
          >
            <AboutSection5Heading v-if="activeStatus" style="width:64%">
              <!-- <SectionHeadingControlLeftRight style="position:absolute;right:0"/> -->
            </AboutSection5Heading>
          </transition>
          <transition
          ...
          >
            <AboutSection5Body
              ...
              style="width:72%;height: calc(85vh - 280px); display: flex; flex-direction: column;"
            />
          </transition>
          <transition
            name="heading_fade"
            mode="out-in"
          >
            <div v-if="activeStatus" class="body_bottom_title">our process always begins with</div>
          </transition>
          <transition
            name="second_line_fade"
            mode="out-in"
          >
            <SectionLine v-if="activeStatus" style="margin-bottom:17px;width:60%;position: absolute; top:85vh"/>
          </transition>
          <transition
            name="footer_fade"
            mode="out-in"
          >
            <AboutSection5Footer v-if="activeStatus" style="width:100%; position: absolute; top:85.5vh"/>
          </transition>
...
import AboutSection5Footer from '@/components/AboutView/AboutSection5/AboutSection5Footer.vue';
import AboutSection5Heading from '@/components/AboutView/AboutSection5/AboutSection5Heading.vue';
import AboutSection5Body from '@/components/AboutView/AboutSection5/AboutSection5Body.vue';
