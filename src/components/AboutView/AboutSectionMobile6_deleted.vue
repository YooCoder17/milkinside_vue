        ...
        <div class="c-intro__content__wrapper" data-intro-content-wrapper="">
          <transition appear name="intro_fade" mode="out-in">
            <div v-if="activeStatus" class="c-intro__content" data-intro-content="">
              <div class="c-intro__left"><p class="c-intro__number">07</p>
                <div class="c-line__wrapper">
                  <div class="c-intro__line c-line"></div>
                </div>
                <p class="c-intro__text">RECENT QUESTIONS</p></div>
            </div>
          </transition>
          <transition appear name="body_title_fade" mode="out-in">
            <h2 v-if="activeStatus" class="main-hd">Studio is always looking for like-minded people:</h2> 
          </transition>
          <br>
          <transition appear name="body_content_fade" mode="out-in">
            <p v-if="activeStatus" >Designers, Art & Technical Directors, Creative Coders and other Creatives.</p> 
          </transition>
          <br>
          <transition appear name="bottom_fade" mode="out-in">
            <div v-if="activeStatus" >
              <div class="row">
                <div class="col2">
                  <h2 class="sub-hd">Milkinside Enters a New Era</h2> 
              ...
              <div class="row">
                <div class="col2">
                  <h2 class="sub-hd">How Organizations Can Experience</h2> 
                    <div class="c-what-we-do__product-line">
                      <div class="c-what-we-do__product-line--bar"></div>
                      <div class="c-what-we-do__product-line--faded-bar"></div>
                    </div>
              ...
              <div class="row">
                <div class="col2">
                  <h2 class="sub-hd">The Design Mind Milkinside is named </h2> 
                    <div class="c-what-we-do__product-line">
                      <div class="c-what-we-do__product-line--bar"></div>
                      <div class="c-what-we-do__product-line--faded-bar"></div>
                    </div>
          ...
          <br>
          <transition appear name="bottom_image_fade" mode="out-in">
            <div style="width:100%;position: relative; z-index: 2; height: 45vh;margin-bottom:30rem">
                <transition
                  name="slide_fade"
                  mode="out-in"
                >
                ...
                <div v-show="activeStatus" style="margin-right:auto;margin-left:auto;display: flex;width:100px;position: absolute;top:40vh;margin-left:40vw">
                    <div id="dot6" class="dots6" style="border-radius: 3px; background: white;width: 18px;height: 4px;opacity:1;margin-right:8px"></div>
                    <div id="dot7" class="dots6" style="border-radius: 3px; background: white;width: 5px;height: 5px;opacity:0.4;margin-right:8px"></div>
                    <div id="dot8" class="dots6" style="border-radius: 3px; background: white;width: 5px;height: 5px;opacity:0.4;margin-right:8px"></div>          
                </div>
              </div>  
          </transition>
          <br>    
...
export default {
  ...
  methods: {    
    changeSlideIndex(){
        ...
        if(this.slide_index >= 3)
          this.slide_index = 0;    
          let dots = document.getElementsByClassName("dots6");
        let index;
  ...
  computed:{
    activeStatus(){
      ...
      return this.activeSectionIndex === 6;
    }
  },
};
</script>
...
.bottom_image_fade-enter-active { width: 1; transition: all 0.8s cubic-bezier(.71,.17,.14,.93);}
.bottom_image_fade-leave-active { transition: all 0.8s cubic-bezier(0.66, 0.00, 0.00, 1.00);}
.bottom_image_fade-enter { transform:translateX(-350px);opacity: 0; }
.bottom_image_fade-leave-to { transform:translateX(-350px); opacity: 0;}
...
.bottom_fade-leave-to { transform:translateY(150px); opacity: 0;}
