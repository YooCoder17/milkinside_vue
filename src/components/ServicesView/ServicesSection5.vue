        ...
        <div class="c-services__sections">
          ...
          <transition
            ...
            <div
              ...
              style="display: flex;"
            >
              <div class="c-nav" style="padding:50px 0 30px 0">
              ...
              <transition
                        ...
                        mode="out-in"
                      >
                  <div v-if="activeStatus" class="c-we-think__content" style="margin-bottom: auto;">
                    <div class="c-intro">
                        <SectionLine/>
                      ...
                      <div v-if="activeStatus" class="c-we-think__heading-row">
                        <transition
                          ...
                          :duration="200"
                        >
                          <div class="c-we-think__heading" style="font-size: max(2.3rem, 23px);;font-weight:700">{{ sectionAttributes.subtitle }}</div>
                        </transition>
                        <div class="c-we-think__heading-text">
                            <a>{{ "1 98,603,401" }}</a>
              ...
              <transition
                        ...
                        mode="out-in"
                      >
                  <div v-if="activeStatus" class="c-we-think__body">
              ...
              <transition
                        ...
                        mode="out-in"
                      >
                  <div v-if="activeStatus" class="c-menu__footer" style="margin-top:auto;margin-bottom:auto">
              ...
              <transition
                        ...
                        mode="out-in"
                      >
                 <div v-if="activeStatus" style="position: absolute;bottom: 6vh;opacity:0.4">@2024 Milkinside. All rights reserved</div>
              </transition>
              <transition
                        name="section_fade"
                        mode="out-in"
                      >
                      <video v-if="activeStatus" poster="@/assets/images/dark_globe.jpg" width="100%" loop muted autoplay preload="auto" style="position: fixed;
                          top: 0;
                          left: 0;
                          min-width: 100%;
                          min-height: 100%;
                    ...
                    <!-- <AnimatedBackground
                      v-if="activeStatus && this.$store.state.loadedVideoData != null && this.$store.state.loadedVideoData.length > 0"
                      id="background-video"
                      :images="videoData"
                      :noLoop="false"
                      :fps="30"
                      :backgroundMobileOffsetX="0"
                      @finished="false"
                      :class="{'active': moveBackground}"
                    /> -->
              </transition>
            </div>
        </transition>
