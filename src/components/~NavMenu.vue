  ...
  <div class="c-nav" id="c-nav">
    <div class="c-nav__wrapper"
      ...
      <router-link
        ...
        @mouseenter.native="onLogoEnter" @mouseleave.native="onLogoLeave"
      ...
      >
        ...
        <div id="logo-animation" style="transform:scale3d(.7, .7, .7) translateX(-290px) translateY(-160px); position:absolute"></div>
      </router-link>
    ...
    onLogoEnter(){
      ...
      if( this.$store.state.nav_light)
        ...
        lottie.loadAnimation({
          ...
          loop: false,
          autoplay: true,
          animationData: whiteLogoAnimation,
        });
    },
    onLogoLeave(){
...
<style scoped>
.logo_fade-enter-active { opacity: 1; transition: all 0.4s cubic-bezier(.71,.17,.14,.93);}
.logo_fade-leave-active { transition: all 0.2s cubic-bezier(0.66, 0.00, 0.00, 1.00);}
.logo_fade-enter { opacity: 0;}
.logo_fade-leave-to {opacity: 0;}
</style>
